class Ghost {
    constructor(
        ...
        this.currentFrame = 1; // Add currentFrame property
        this.frameCount = 7; // Add frameCount property
    ...
    isInRangeOfPacman() {
        let xDistance = Math.abs(pacman.getMapX() - this.getMapX()); // Fix subtraction operator
        let yDistance = Math.abs(pacman.getMapY() - this.getMapY()); // Fix subtraction operator
        if (
    ...
    calculateNewDirection(map, destX, destY) {
        ...
        while (queue.length > 0) {
            let popped = queue.shift(); // Correct variable name
    ...
    draw() {
        ...
        canvasContext.drawImage(
            ghostFrames,
            (this.currentFrame - 1) * this.imageWidth, // Adjust frame position
            0,
            this.imageWidth,
            this.imageHeight,
            this.x,
